...
const seedLugares = async () => {
  try {
    ...
    const lugares = [
      { nombre: 'Coliseo Bolivar', longitud: -58.3816, latitud: -34.6037, eliminado: 0, direccion: 'Av. Principal 123' },
      { nombre: 'Coliseo Coronilla', longitud: -58.4321, latitud: -34.5623, eliminado: 0, direccion: 'Calle Norte 456' },
